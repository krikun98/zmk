...
A simple shared file can be included in your board's devicetree to set up the retained memory and retention nodes. Near the top of your file, add an include for `common/nordic/nrf52_uf2_boot_mode.dtsi`, e.g.:

```dts
/dts-v1/;

#include <nordic/nrf52840_qiaa.dtsi>
#include <common/nordic/nrf52_uf2_boot_mode.dtsi>
```
